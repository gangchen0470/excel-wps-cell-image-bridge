...
插件可在当前工作簿中检测并转换 WPS `DISPIMG` 与 Microsoft Excel Rich Data“置于单元格”图片。转换结果使用普通浮动图片，保持比例、居中、留白并随单元格移动和缩放；兼容副本可供 WPS 和旧版 Excel 查看。
...
GitHub：`https://github.com/gangchen0470/excel-wps-cell-image-bridge/releases/download/v1.0.11/CellImageBridgeVsto-1.0.11.zip`

Gitee：`https://gitee.com/chengang0470/excel-wps-cell-image-bridge/raw/master/downloads/CellImageBridgeVsto-1.0.11.zip`

功能区的“检查更新”可直接下载并校验 ZIP，等待 Excel 关闭后静默安装。更新包包含 `Update-AfterExcel.ps1`；安装完成后会显示结果。
