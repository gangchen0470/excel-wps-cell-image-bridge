...
copy /y "%~dp0bin\Release\Microsoft.Office.Tools.Common.v4.0.Utilities.dll" "%OUTPUT%\Application Files\CellImageBridgeVsto_1_0_2_0\Microsoft.Office.Tools.Common.v4.0.Utilities.dll.deploy" >nul
if not exist "%OUTPUT%\CellImageBridgeVsto.vsto" goto failed
if not exist "%OUTPUT%\Application Files\CellImageBridgeVsto_1_0_2_0\Microsoft.Office.Tools.Common.v4.0.Utilities.dll.deploy" goto failed
